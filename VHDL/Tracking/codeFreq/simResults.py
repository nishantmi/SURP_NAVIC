#Code to analyse the output from the simulation of codeError VHDL code
...
for line in f:
    ...
    out_var = FixedPoint('0b'+out_var, signed = 1, m = 8, n =24, str_base = 2)
    out     = FixedPoint('0b'+out, signed = 1, m = 8, n =24, str_base = 2)
...
for line in f1:
    ...
    diff2.append(float(FixedPoint('0b'+carrErrorDiff, signed = True, m = 8, n =24, str_base = 2)))  #Stores the carrErrorDiff
